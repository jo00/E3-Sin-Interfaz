...
public class AllTargetMagicEffect:OffensivePhysEffect

{
    ...
    public AllTargetMagicEffect(UnitData unitDataAttacking, int skillPower, ImplementedConsoleView view, TeamController teamController, string type) : base(unitDataAttacking)
    {
