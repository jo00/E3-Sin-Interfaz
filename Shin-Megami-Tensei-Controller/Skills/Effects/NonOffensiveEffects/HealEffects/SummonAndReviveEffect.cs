...
public class SummonAndReviveEffect : Effect
{
    ...
    public SummonAndReviveEffect(Unit unitAttacking, TeamData teamData, View view, TurnsController turnsController, SummonController summonController)
        : base(unitAttacking)
    {
    ...
    {
        if (!_summonController.SummonAndReviveFromAbility(_unitAttacking, _teamData,
