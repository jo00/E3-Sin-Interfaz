...
public interface IView
{
    ...
    void ShowEffectOfDamage(UnitData unitDataAttacking, UnitData target, int damageWithAffinities);
    void ShowGunTarget(UnitData unitDataAttacking, UnitData target);
    void ShowAttackTarget(UnitData unitDataAttacking, UnitData target);
    void ShowFireTarget(UnitData unitDataAttacking, UnitData target);
    void ShowIceTarget(UnitData unitDataAttacking, UnitData target);
    void ShowElecTarget(UnitData unitDataAttacking, UnitData target);
    void ShowForceTarget(UnitData unitDataAttacking, UnitData target);
    void ShowHealAllyTarget(UnitData unitDataAttacking, UnitData target);
    void ShowReviveAllyTarget(UnitData unitDataAttacking, UnitData target);
